...
Try {
	...
	[string]$appVendor = ''
	[string]$appName = 'FitnessGram Shortcut'
	[string]$appVersion = ''
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '02/9/2018'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		## <Perform Installation tasks here>
				Remove-File -Path "$envPublic\Desktop\FITNESSGRAM - ACTIVITYGRAM Login.url"
				Copy-File -Path "$dirFiles\FitnessGram.url" -Destination "$envPublic\Desktop"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		# <Perform Uninstallation tasks here>
				Remove-File -Path "$envPublic\Desktop\FitnessGram.url"
